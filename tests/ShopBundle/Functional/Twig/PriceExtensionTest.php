...
class PriceExtensionTest extends FunctionalTestCase
{
    ...
    private function getPriceExtensionWithMockedConfiguration(): PriceExtension
    {
        ...
        $domainConfig1 = $this->domain->getDomainConfigById(1);
        $domainConfig2 = $this->domain->getDomainConfigById(2);
        ...
        $localization = new Localization($this->domain, $domainConfig1->getLocale());
