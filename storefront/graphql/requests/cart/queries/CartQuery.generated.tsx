...
export function useCartQuery(options?: Omit<Urql.UseQueryArgs<TypeCartQueryVariables>, 'query'>) {
  return Urql.useQuery<TypeCartQuery, TypeCartQueryVariables>({ query: CartQueryDocument, ...options });
};