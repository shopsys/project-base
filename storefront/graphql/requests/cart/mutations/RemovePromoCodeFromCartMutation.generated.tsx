...
export type TypeRemovePromoCodeFromCartMutationVariables = Types.Exact<{
  input: Types.TypeRemovePromoCodeFromCartInput;
}>;
...
export function useRemovePromoCodeFromCartMutation() {
  return Urql.useMutation<TypeRemovePromoCodeFromCartMutation, TypeRemovePromoCodeFromCartMutationVariables>(RemovePromoCodeFromCartMutationDocument);
};