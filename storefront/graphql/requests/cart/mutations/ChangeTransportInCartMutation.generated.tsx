...
export const ChangeTransportInCartMutationDocument = gql`
...
export function useChangeTransportInCartMutation() {
  return Urql.useMutation<TypeChangeTransportInCartMutation, TypeChangeTransportInCartMutationVariables>(ChangeTransportInCartMutationDocument);
};