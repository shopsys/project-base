...
class AllowedDatabaseColumnsProviderTest extends AbstractDatabaseSchemaFunctionalTestCase
{
    ...
    public function testGetAllowedColumnsSetIndexedByTableNamesReturnsAllowlistedTablesAndColumns(): void
    {
        $allowedColumnsSetIndexedByTableNames = $this->allowedDatabaseColumnsProvider->getAllowedColumnsSetIndexedByTableNames([
            QueryableEntity::TABLE_NAME,
    ...
    public function testGetAllowedColumnsSetIndexedByTableNamesIncludesColumnsInheritedFromMappedSuperclassWithPropertyLevelMcpAttributes(): void
    {
        $allowedColumnsSetIndexedByTableNames = $this->allowedDatabaseColumnsProvider->getAllowedColumnsSetIndexedByTableNames([
            ParentAttributedQueryableEntity::TABLE_NAME,
        ]);
    ...
    public function testGetAllowedColumnsSetIndexedByTableNamesReturnsNoTablesForEmptyRequestedTableNames(): void
    {
        $allowedColumnsSetIndexedByTableNames = $this->allowedDatabaseColumnsProvider->getAllowedColumnsSetIndexedByTableNames([]);

        $this->assertSame([], $allowedColumnsSetIndexedByTableNames);
    }
}
