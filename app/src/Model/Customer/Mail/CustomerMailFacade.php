 ...
 * @method sendActivationMailTemplate(\App\Model\Mail\MailTemplate $mailTemplate, \Shopsys\FrameworkBundle\Model\Customer\User\ResetPasswordInterface $customerUser, string|null $forceSendTo = null)
 */
