 ...
 * @method void editOrderTransport(\App\Model\Order\OrderData $orderData)
 * @method void editOrderPayment(\App\Model\Order\OrderData $orderData)
 * @method void setDeliveryAddress(\App\Model\Order\OrderData $orderData)
 * @method void addItem(\App\Model\Order\Item\OrderItem $item)
 * @method void removeItem(\App\Model\Order\Item\OrderItem $item)
 * @method void fillCommonFields(\App\Model\Order\OrderData $orderData)
 * @property \App\Model\Order\Status\OrderStatus $status
 * @method void setStatus(\App\Model\Order\Status\OrderStatus $status)
 ...
 * @method void editData(\App\Model\Order\OrderData $orderData)
